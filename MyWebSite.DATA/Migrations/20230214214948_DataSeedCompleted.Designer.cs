...
namespace MyWebSite.DATA.Migrations
{
    ...
    [Migration("20230214214948_DataSeedCompleted")]
    partial class DataSeedCompleted
    {
            ...
            modelBuilder.Entity("MyWebSite.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("71b9fadb-7249-44d0-8f66-61aead4054e9"),
                            ...
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(8452),
                        ...
                        new
                        {
                            ID = new Guid("4f8f2607-dbf0-4b0a-b885-96138c2f3051"),
                            CategoryId = new Guid("38321b2d-2af8-4b6e-9d05-4cc56c4f7695"),
                            Content = "lorem ipsum dolor hello world deneme makale içeriği data seed aşamasındali denemeler.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(8469),
            ...
            modelBuilder.Entity("MyWebSite.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(9180),
                            IsDeleted = false,
                            Name = "ASP .NET CORE"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(9208),
                            IsDeleted = false,
                            Name = "Visual Studio"
                        });
                });
            ...
            modelBuilder.Entity("MyWebSite.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7dd728b5-eb76-4624-bc94-25e3b9c1bde1"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(9778),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2023, 2, 15, 0, 49, 47, 578, DateTimeKind.Local).AddTicks(9787),
                            FileName = "images/testimage",
                            FileType = "jpg",
                            IsDeleted = false
                        });
